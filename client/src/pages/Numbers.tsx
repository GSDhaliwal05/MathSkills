...
export default function Numbers() {
  const content = mathContent.numbers;
  ...
  return (
    <div>
      ...
      >
        <h1 className="text-4xl font-bold mb-4 font-['Poppins']">Numbers</h1>
        <p className="text-xl opacity-90">Master factors, multiples, LCM, GCF, and prime/composite numbers</p>
      </motion.div>
