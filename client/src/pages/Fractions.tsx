...
export default function Fractions() {
  const content = mathContent.fractions;
  ...
  return (
    <div>
      ...
      >
        <h1 className="text-4xl font-bold mb-4 font-['Poppins']">Fractions</h1>
        <p className="text-xl opacity-90">Simplifying, equivalent fractions, conversions, and operations</p>
      </motion.div>
      ...
      {/* Examples */}
      <ExampleSection examples={content.examples} color="blue-500" />
