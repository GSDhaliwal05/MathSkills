...
export default function Exponents() {
  const content = mathContent.exponents;
  ...
  return (
    <div>
      ...
      >
        <h1 className="text-4xl font-bold mb-4 font-['Poppins']">Exponents</h1>
        <p className="text-xl opacity-90">Squares, square roots, BEDMAS, scientific notation, and powers</p>
      </motion.div>
